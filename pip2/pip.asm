...
DEFALT	DS	6		DEFAULT BLOCK

MWNA	DS	FB.NAML		MWN WORK AREA

	IF	.PIP.
DESTBUF DS	256		DESTINATION FILE BUFFER (ALSO USED BY *CCW*)
DESTBFE EQU	*		END OF BUFFER
	ENDIF
...
SLABEL	DS	256		Saved Label Sector			/2.0a/
LABEL	DS	256		Label Sector				/2.0a/
...
$FOPWRK DS	FB.NAML		WORK AREA FOR $FOPE


	IF	.PIP.
	ERRMI	*-MEML		FOLLOWING MUST NOT OVERLAY *PRS*
	ENDIF
LINE	DS	80		COMMAND BUFFER
